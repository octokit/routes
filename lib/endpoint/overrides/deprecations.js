 ...
 *    },
 *    after: {
 *      operationId: "issues-and-pull-requests"
 *    }
 *
...
function deprecations({ routes }) {
  ...
  getOrCreateAuthorizationForAppAndFingerprint &&
    getOrCreateAuthorizationForAppAndFingerprint.operation["x-changes"].push({
      ...
      before: {
        operationId: "get-or-create-authorization-for-app-fingerprint"
      },
      after: {
        operationId: "get-or-create-authorization-for-app-and-fingerprint"
      }
    });
  ...
  provisionAndInviteUsers &&
    provisionAndInviteUsers.operation["x-changes"].push({
      ...
      before: {
        operationId: "provision-invite-users"
      },
      after: {
        operationId: "provision-and-invite-users"
      }
    });
  ...
  listLicenses &&
    listLicenses.operation["x-changes"].push({
      ...
      after: {
        operationId: "list-commonly-used"
      }
    });
  ...
  replaceProvisionedUserInformation &&
    replaceProvisionedUserInformation.operation["x-changes"].push({
      ...
      before: {
        operationId: "update-provisioned-org-membership"
      },
      after: {
        operationId: "replace-provisioned-user-information"
      }
    });
  ...
  getRepoInstallation &&
    getRepoInstallation.operation["x-changes"].push({
      ...
      before: {
        operationId: "find-repo-installation"
      },
      after: {
        operationId: "get-repo-installation"
      }
    });
  ...
  getUserInstallation &&
    getUserInstallation.operation["x-changes"].push({
      ...
      note:
        '"Find repository installation" renamed to "Get a repository installation"',
      before: {
        operationId: "find-user-installation"
      },
      after: {
        operationId: "get-user-installation"
      }
    });
  ...
  if (
    ...
    createOrUpdateFile.operation["x-changes"].push({
      ...
      after: {
        operationId: "create-or-update-file"
      }
    });
    createOrUpdateFile.operation["x-changes"].push({
      type: "operation",
  ...
  if (createPullRequestReviewComment) {
    createPullRequestReviewComment.operation["x-changes"].push({
      ...
      before: {
        operationId: "create-comment-reply"
      },
      after: {
  ...
  const listTeamsWithAccessToProtectedBranch = findByRoute(
    routes,
  ...
  if (listTeamsWithAccessToProtectedBranch) {
    listTeamsWithAccessToProtectedBranch.operation["x-changes"].push({
      ...
      date: "2019-09-09",
      note:
        '"List team restrictions of protected branch" is now "List teams with access to protected branch"',
      before: {
        operationId: "list-protected-branch-team-restrictions"
      },
      after: {
        operationId: "list-teams-with-access-to-protected-branch"
      }
    });
  }

  // 2019-09-09 idName changed for "List user restrictions of protected branch"
  const listUsersWithAccessToProtectedBranch = findByRoute(
    routes,
  ...
  if (listUsersWithAccessToProtectedBranch) {
    listUsersWithAccessToProtectedBranch.operation["x-changes"].push({
      ...
      date: "2019-09-09",
      note:
        '"List user restrictions of protected branch" is now "List users with access to protected branch"',
      before: {
        operationId: "list-protected-branch-user-restrictions"
      },
      after: {
        operationId: "list-users-with-access-to-protected-branch"
      }
    });
  }
}
