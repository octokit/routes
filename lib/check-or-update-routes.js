...
function paramMappedToBody (endpoint) {
  const param = endpoint.params.find(param => param.mapTo === 'input')
...
function toRequestBodySchema (endpoint) {
  // const paramSentAsRoot = endpoint.params.find(param => param.mapTo === 'data')
